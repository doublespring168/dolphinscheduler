...
- `dolphinscheduler-ui/src/main.ts`
- `dolphinscheduler-ui/src/App.tsx`
- `dolphinscheduler-ui/src/router/index.ts`
- `dolphinscheduler-ui/src/router/routes.ts`
- `dolphinscheduler-ui/src/router/modules/*.ts`
...
- `dolphinscheduler-ui/src/layouts`
- `dolphinscheduler-ui/src/views/**/components`
...
- `dolphinscheduler-ui/src/views/login/use-form.ts`
- `dolphinscheduler-ui/src/views/home/use-table.ts`
- `dolphinscheduler-ui/src/views/projects/**/use-table.ts`
- `dolphinscheduler-ui/src/views/projects/**/use-form.ts`
- `dolphinscheduler-ui/src/views/resource/**/use-create.ts`
- `dolphinscheduler-ui/src/views/resource/**/use-upload.ts`
...
- `dolphinscheduler-ui/src/store/user`
- `dolphinscheduler-ui/src/store/project`
- `dolphinscheduler-ui/src/store/theme`
- `dolphinscheduler-ui/src/store/locales`
- `dolphinscheduler-ui/src/store/ui-setting`
- `dolphinscheduler-ui/src/store/timezone`
...
- `dolphinscheduler-ui/src/service/modules/*/index.ts`
- `dolphinscheduler-ui/src/service/modules/*/types.ts`
...
- `dolphinscheduler-ui/src/router/modules/datasource.ts`
...
- `dolphinscheduler-ui/src/service/modules/ui-plugins`
- `dolphinscheduler-ui/src/service/modules/dynamic-dag`
...
| Alert Server | `dolphinscheduler-alert` | 处理告警事件和告警插件发送 |
| Registry | `dolphinscheduler-registry` | 节点注册、服务发现、高可用、分布式锁、事件订阅 |
| Metadata DB | `dolphinscheduler-dao` | 保存项目、工作流定义、实例、任务实例、命令、用户、资源元数据 |
...
- `dolphinscheduler-dao/src/main/java/org/apache/dolphinscheduler/dao/mapper`
...
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/engine/task/lifecycle`
- `dolphinscheduler-worker/src/main/java/org/apache/dolphinscheduler/server/worker/executor/PhysicalTaskExecutorEventBusCoordinator.java`
...
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/engine/command`
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/engine/command/handler`
...
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/engine/workflow/statemachine`
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/engine/task/statemachine`
...
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/engine/workflow/execution`
- `dolphinscheduler-service/src/main/java/org/apache/dolphinscheduler/service/process/WorkflowDag.java`
...
后端 Server 之间通过 `dolphinscheduler-extract` 定义 RPC 契约，具体实现位于 Master、Worker、Alert 等运行模块。

代表模块：

- `dolphinscheduler-extract/dolphinscheduler-extract-base`
- `dolphinscheduler-extract/dolphinscheduler-extract-master`
- `dolphinscheduler-extract/dolphinscheduler-extract-worker`
- `dolphinscheduler-extract/dolphinscheduler-extract-alert`
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/rpc`
- `dolphinscheduler-worker/src/main/java/org/apache/dolphinscheduler/server/worker/rpc`
...
```mermaid
flowchart LR
  Extract["dolphinscheduler-extract 接口契约"] --> MasterRpc["Master RPC 实现"]
...
- `dolphinscheduler-registry/dolphinscheduler-registry-api`
- `dolphinscheduler-registry/dolphinscheduler-registry-plugins`
- `dolphinscheduler-registry/dolphinscheduler-registry-all`
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/registry`
- `dolphinscheduler-worker/src/main/java/org/apache/dolphinscheduler/server/worker/registry`
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/cluster`
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/failover`
...
- `dolphinscheduler-dao/src/main/java/org/apache/dolphinscheduler/dao/repository`
- `dolphinscheduler-dao/src/main/java/org/apache/dolphinscheduler/dao/repository/impl`
- `dolphinscheduler-dao/src/main/java/org/apache/dolphinscheduler/dao/mapper`
- `dolphinscheduler-dao/src/main/java/org/apache/dolphinscheduler/dao/entity`
...
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/cluster/loadbalancer`
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/engine/workflow/policy`
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/engine/workflow/trigger`
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/engine/executor/plugin`
...
- `dolphinscheduler-api/src/main/java/org/apache/dolphinscheduler/api/security`
- `dolphinscheduler-api/src/main/java/org/apache/dolphinscheduler/api/audit`
- `dolphinscheduler-api/src/main/java/org/apache/dolphinscheduler/api/exceptions/ApiExceptionHandler.java`
- `dolphinscheduler-master/src/main/java/org/apache/dolphinscheduler/server/master/metrics`
- `dolphinscheduler-worker/src/main/java/org/apache/dolphinscheduler/server/worker/metrics`
...
| 架构模式 | 代表位置 | 解决的问题 |
| --- | --- | --- |
| Master-Worker 分布式模式 | `dolphinscheduler-master`、`dolphinscheduler-worker` | 调度编排和任务执行分离，支持横向扩展 |
...
| RPC 契约模式 | `dolphinscheduler-extract`、`server/*/rpc` | 解耦 Master、Worker、Alert 等进程间通信 |
| 注册中心 HA 模式 | `dolphinscheduler-registry`、`cluster`、`failover` | 服务发现、节点监听、分布式锁、故障恢复 |
...
dolphinscheduler-api
  ...
  -> dolphinscheduler-registry-api/all
  -> plugin api/manager
...
6. 看跨进程通信：`dolphinscheduler-extract` 和 Master/Worker 的 `rpc` 包。
