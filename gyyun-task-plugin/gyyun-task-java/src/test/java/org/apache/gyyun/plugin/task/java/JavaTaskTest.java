...
package org.apache.gyyun.plugin.task.java;

import static com.google.common.truth.Truth.assertThat;
import static org.apache.gyyun.plugin.task.api.enums.DataType.VARCHAR;
import static org.apache.gyyun.plugin.task.api.enums.Direct.IN;
import static org.apache.gyyun.plugin.task.java.JavaConstants.RUN_TYPE_FAT_JAR;
import static org.apache.gyyun.plugin.task.java.JavaConstants.RUN_TYPE_NORMAL_JAR;
...
import org.apache.gyyun.plugin.task.api.model.ResourceInfo;
import org.apache.gyyun.plugin.task.api.resource.ResourceContext;
...
class JavaTaskTest {
    ...
    void buildJarCommand() {
        ...
        assertThat(javaTask.buildJarCommand())
                .isEqualTo(
                        "${JAVA_HOME}/bin/java -xms:50m -classpath .:/tmp/gyyun/test/executepath:/tmp/gyyun/test/executepath/opt/share/jar/resource2.jar -jar /tmp/gyyun/test/executepath/opt/share/jar/main.jar -host 127.0.0.1 -port 8080");
    }
    ...
    void buildNormalJarCommand() {
        ...
        assertThat(javaTask.buildNormalJarCommand())
                .isEqualTo(
                        "${JAVA_HOME}/bin/java -xms:50m -classpath .:/tmp/gyyun/test/executepath:/tmp/gyyun/test/executepath/opt/share/jar/resource2.jar:/tmp/gyyun/test/executepath/opt/share/jar/main.jar Test -host 127.0.0.1 -port 8080");
    }
    ...
    void testParameterPass() {
        ...
        assertThat(javaTask.buildNormalJarCommand())
                .isEqualTo(
                        "${JAVA_HOME}/bin/java -xms:1G -classpath .:/tmp/gyyun/test/executepath:/tmp/gyyun/test/executepath/opt/share/jar/resource2.jar Test -host 0.0.0.0 -port 12345");
    }
    ...
    private ResourceContext createResourceContext() {
        ...
        resourceItem1
                .setResourceAbsolutePathInLocal("/tmp/gyyun/test/executepath/opt/share/jar/resource2.jar");
        ...
        resourceItem2.setResourceAbsolutePathInLocal("/tmp/gyyun/test/executepath/opt/share/jar/main.jar");
    ...
    private JavaTask runJarType() {
        ...
        taskExecutionContext.setExecutePath("/tmp/gyyun/test/executepath");
    ...
    private void packageTestJar() {
        ...
        String jarDirPath = "/tmp/gyyun/test/executepath/opt/share/jar";
