...
package org.apache.gyyun.plugin.task.sqoop.generator.sources;

import static org.apache.gyyun.plugin.datasource.api.utils.PasswordUtils.decodePassword;
import static org.apache.gyyun.plugin.task.api.TaskConstants.COMMA;
import static org.apache.gyyun.plugin.task.api.TaskConstants.DOUBLE_QUOTES;
import static org.apache.gyyun.plugin.task.api.TaskConstants.EQUAL_SIGN;
import static org.apache.gyyun.plugin.task.api.TaskConstants.SPACE;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.COLUMNS;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.DB_CONNECT;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.DB_PWD;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.DB_USERNAME;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.DRIVER;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.MAP_COLUMN_HIVE;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.MAP_COLUMN_JAVA;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.QUERY;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.QUERY_CONDITION;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.QUERY_WHERE;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.QUERY_WITHOUT_CONDITION;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.TABLE;

import org.apache.gyyun.common.utils.JSONUtils;
import org.apache.gyyun.plugin.datasource.api.utils.DataSourceUtils;
import org.apache.gyyun.plugin.task.api.model.Property;
import org.apache.gyyun.plugin.task.sqoop.SqoopQueryType;
import org.apache.gyyun.plugin.task.sqoop.SqoopTaskExecutionContext;
import org.apache.gyyun.plugin.task.sqoop.generator.ISourceGenerator;
import org.apache.gyyun.plugin.task.sqoop.parameter.SqoopParameters;
import org.apache.gyyun.plugin.task.sqoop.parameter.sources.SourceSqlServerParameter;
import org.apache.gyyun.spi.datasource.BaseConnectionParam;
import org.apache.gyyun.spi.enums.DbType;
