...
package org.apache.gyyun.plugin.task.sqoop.parameter;

import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.HANA;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.HDFS;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.HIVE;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.MYSQL;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.ORACLE;
import static org.apache.gyyun.plugin.task.sqoop.SqoopConstants.SQLSERVER;

import org.apache.gyyun.common.utils.JSONUtils;
import org.apache.gyyun.plugin.task.api.enums.ResourceType;
import org.apache.gyyun.plugin.task.api.model.Property;
import org.apache.gyyun.plugin.task.api.parameters.AbstractParameters;
import org.apache.gyyun.plugin.task.api.parameters.resource.DataSourceParameters;
import org.apache.gyyun.plugin.task.api.parameters.resource.ResourceParametersHelper;
import org.apache.gyyun.plugin.task.sqoop.SqoopJobType;
import org.apache.gyyun.plugin.task.sqoop.SqoopTaskExecutionContext;
import org.apache.gyyun.plugin.task.sqoop.parameter.sources.SourceHanaParameter;
import org.apache.gyyun.plugin.task.sqoop.parameter.sources.SourceHdfsParameter;
import org.apache.gyyun.plugin.task.sqoop.parameter.sources.SourceHiveParameter;
import org.apache.gyyun.plugin.task.sqoop.parameter.sources.SourceMysqlParameter;
import org.apache.gyyun.plugin.task.sqoop.parameter.sources.SourceOracleParameter;
import org.apache.gyyun.plugin.task.sqoop.parameter.sources.SourceSqlServerParameter;
import org.apache.gyyun.plugin.task.sqoop.parameter.targets.TargetHanaParameter;
import org.apache.gyyun.plugin.task.sqoop.parameter.targets.TargetHdfsParameter;
import org.apache.gyyun.plugin.task.sqoop.parameter.targets.TargetHiveParameter;
import org.apache.gyyun.plugin.task.sqoop.parameter.targets.TargetMysqlParameter;
import org.apache.gyyun.plugin.task.sqoop.parameter.targets.TargetOracleParameter;
import org.apache.gyyun.plugin.task.sqoop.parameter.targets.TargetSqlServerParameter;
