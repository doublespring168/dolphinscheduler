...
package com.gyyun.ds.plugin.task.sqoop.generator.sources;

import static com.gyyun.ds.plugin.datasource.api.utils.PasswordUtils.decodePassword;
import static com.gyyun.ds.plugin.task.api.TaskConstants.COMMA;
import static com.gyyun.ds.plugin.task.api.TaskConstants.DOUBLE_QUOTES;
import static com.gyyun.ds.plugin.task.api.TaskConstants.EQUAL_SIGN;
import static com.gyyun.ds.plugin.task.api.TaskConstants.SPACE;
import static com.gyyun.ds.plugin.task.sqoop.SqoopConstants.COLUMNS;
import static com.gyyun.ds.plugin.task.sqoop.SqoopConstants.DB_CONNECT;
import static com.gyyun.ds.plugin.task.sqoop.SqoopConstants.DB_PWD;
import static com.gyyun.ds.plugin.task.sqoop.SqoopConstants.DB_USERNAME;
import static com.gyyun.ds.plugin.task.sqoop.SqoopConstants.DRIVER;
import static com.gyyun.ds.plugin.task.sqoop.SqoopConstants.MAP_COLUMN_HIVE;
import static com.gyyun.ds.plugin.task.sqoop.SqoopConstants.MAP_COLUMN_JAVA;
import static com.gyyun.ds.plugin.task.sqoop.SqoopConstants.QUERY;
import static com.gyyun.ds.plugin.task.sqoop.SqoopConstants.QUERY_CONDITION;
import static com.gyyun.ds.plugin.task.sqoop.SqoopConstants.QUERY_WHERE;
import static com.gyyun.ds.plugin.task.sqoop.SqoopConstants.QUERY_WITHOUT_CONDITION;
import static com.gyyun.ds.plugin.task.sqoop.SqoopConstants.TABLE;

import com.gyyun.ds.common.utils.JSONUtils;
import com.gyyun.ds.plugin.datasource.api.utils.DataSourceUtils;
import com.gyyun.ds.plugin.task.api.model.Property;
import com.gyyun.ds.plugin.task.sqoop.SqoopQueryType;
import com.gyyun.ds.plugin.task.sqoop.SqoopTaskExecutionContext;
import com.gyyun.ds.plugin.task.sqoop.generator.ISourceGenerator;
import com.gyyun.ds.plugin.task.sqoop.parameter.SqoopParameters;
import com.gyyun.ds.plugin.task.sqoop.parameter.sources.SourceSqlServerParameter;
import com.gyyun.ds.spi.datasource.BaseConnectionParam;
import com.gyyun.ds.spi.enums.DbType;
