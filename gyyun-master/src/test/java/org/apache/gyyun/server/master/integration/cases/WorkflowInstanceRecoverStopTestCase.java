...
package org.apache.gyyun.server.master.integration.cases;
...
import org.apache.gyyun.server.master.AbstractMasterIntegrationTestCase;
import org.apache.gyyun.server.master.integration.WorkflowOperator;
import org.apache.gyyun.server.master.integration.WorkflowTestCaseContext;
                ...
                .untilAsserted(() -> {
                    ...
                    assertThat(repository.queryTaskInstance(subWorkflowInstances.get(0).getId()))
                            ...
                            .satisfies(taskInstance -> {
                                ...
                                assertThat(taskInstance.get(2).getFlag()).isEqualTo(Flag.YES);
                            });
                });
