...
package com.gyyun.ds.server.master.engine;

import com.gyyun.ds.common.constants.Constants;
import com.gyyun.ds.common.enums.Flag;
import com.gyyun.ds.common.enums.TaskGroupQueueStatus;
import com.gyyun.ds.common.enums.WorkflowExecutionStatus;
import com.gyyun.ds.common.thread.BaseDaemonThread;
...
import com.gyyun.ds.dao.repository.TaskGroupQueueDao;
...
import com.gyyun.ds.extract.master.ITaskInstanceController;
import com.gyyun.ds.extract.master.transportor.TaskGroupSlotAcquireSuccessNotifyRequest;
import com.gyyun.ds.extract.master.transportor.TaskGroupSlotAcquireSuccessNotifyResponse;
import com.gyyun.ds.plugin.task.api.enums.TaskExecutionStatus;
import com.gyyun.ds.plugin.task.api.utils.LogUtils;
import com.gyyun.ds.server.master.utils.TaskGroupUtils;
...
public class TaskGroupCoordinator implements ITaskGroupCoordinator, AutoCloseable {
    ...
    /**
     * Make sure the TaskGroup useSize is equal to the TaskGroupQueue which status is {@link TaskGroupQueueStatus#ACQUIRE_SUCCESS} and forceStart is {@link com.gyyun.ds.common.enums.Flag#NO}.
     */
