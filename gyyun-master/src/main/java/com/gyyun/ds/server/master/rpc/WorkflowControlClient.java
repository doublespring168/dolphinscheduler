...
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowBackfillTriggerRequest;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowBackfillTriggerResponse;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowInstancePauseRequest;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowInstancePauseResponse;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowInstanceRecoverFailureTasksRequest;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowInstanceRecoverFailureTasksResponse;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowInstanceRecoverSuspendTasksRequest;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowInstanceRecoverSuspendTasksResponse;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowInstanceRepeatRunningRequest;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowInstanceRepeatRunningResponse;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowInstanceStopRequest;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowInstanceStopResponse;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowManualTriggerRequest;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowManualTriggerResponse;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowScheduleTriggerRequest;
import com.gyyun.ds.extract.master.transportor.workflow.WorkflowScheduleTriggerResponse;
import com.gyyun.ds.server.master.engine.WorkflowCacheRepository;
import com.gyyun.ds.server.master.engine.workflow.execution.IWorkflowExecution;
import com.gyyun.ds.server.master.engine.workflow.trigger.WorkflowBackfillTrigger;
import com.gyyun.ds.server.master.engine.workflow.trigger.WorkflowInstanceRecoverFailureTaskTrigger;
import com.gyyun.ds.server.master.engine.workflow.trigger.WorkflowInstanceRecoverSuspendTaskTrigger;
import com.gyyun.ds.server.master.engine.workflow.trigger.WorkflowInstanceRepeatTrigger;
import com.gyyun.ds.server.master.engine.workflow.trigger.WorkflowManualTrigger;
import com.gyyun.ds.server.master.engine.workflow.trigger.WorkflowScheduleTrigger;
