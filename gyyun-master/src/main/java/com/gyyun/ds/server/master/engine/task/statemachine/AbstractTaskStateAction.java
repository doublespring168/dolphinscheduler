...
package com.gyyun.ds.server.master.engine.task.statemachine;

import static com.google.common.base.Preconditions.checkNotNull;
import static com.gyyun.ds.plugin.task.api.enums.TaskExecutionStatus.DISPATCH;
...
import com.gyyun.ds.plugin.task.api.utils.VarPoolUtils;
import com.gyyun.ds.server.master.engine.AbstractLifecycleEvent;
import com.gyyun.ds.server.master.engine.ITaskGroupCoordinator;
import com.gyyun.ds.server.master.engine.graph.IWorkflowExecutionGraph;
import com.gyyun.ds.server.master.engine.task.client.ITaskExecutorClient;
import com.gyyun.ds.server.master.engine.task.execution.ITaskExecution;
import com.gyyun.ds.server.master.engine.task.lifecycle.event.TaskDispatchLifecycleEvent;
import com.gyyun.ds.server.master.engine.task.lifecycle.event.TaskDispatchedLifecycleEvent;
import com.gyyun.ds.server.master.engine.task.lifecycle.event.TaskFailedLifecycleEvent;
import com.gyyun.ds.server.master.engine.task.lifecycle.event.TaskFatalLifecycleEvent;
import com.gyyun.ds.server.master.engine.task.lifecycle.event.TaskKilledLifecycleEvent;
import com.gyyun.ds.server.master.engine.task.lifecycle.event.TaskPausedLifecycleEvent;
import com.gyyun.ds.server.master.engine.task.lifecycle.event.TaskRetryLifecycleEvent;
import com.gyyun.ds.server.master.engine.task.lifecycle.event.TaskRunningLifecycleEvent;
import com.gyyun.ds.server.master.engine.task.lifecycle.event.TaskRuntimeContextChangedEvent;
import com.gyyun.ds.server.master.engine.task.lifecycle.event.TaskSuccessLifecycleEvent;
import com.gyyun.ds.server.master.engine.workflow.execution.IWorkflowExecution;
import com.gyyun.ds.server.master.engine.workflow.lifecycle.event.WorkflowTopologyLogicalTransitionWithTaskFinishLifecycleEvent;
