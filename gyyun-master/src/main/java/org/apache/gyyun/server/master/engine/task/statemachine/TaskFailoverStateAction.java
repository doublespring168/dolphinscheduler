...
/**
 * The action to be taken when a task is in the NEED_FAULT_TOLERANCE state.
 * <p> The task is in the NEED_FAULT_TOLERANCE state cannot receive any event.
 */
@Slf4j
@Component
public class TaskFailoverStateAction extends AbstractTaskStateAction {
    ...
    public TaskExecutionStatus matchState() {
        return TaskExecutionStatus.NEED_FAULT_TOLERANCE;
    }
}
