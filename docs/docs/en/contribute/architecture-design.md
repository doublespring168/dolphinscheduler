...
- **WorkerServer**
  ...
  - **UI**
    ...
    The front-end page of the system provides various visual operation interfaces of the system. For details, see the [quick start](https://gyyun.apache.org/en-us/docs/3.1.2/about/introduction) section.
