...
Beside submit Issues and pull requests to the GitHub repository mentioned in [team](https://gyyun.apache.org/en-us/community), another important way to
...
> The advantage of this list is when the community has discussion, in addition to the mention Members in [team](https://gyyun.apache.org/en-us/community),
