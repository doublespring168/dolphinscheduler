...
* Problems will be encountered via github on the [issue](https://github.com/apache/gyyun/issues) form feedback out.
...
* All bugs and the features are recommended and managed using the GitHub issues(https://github.com/apache/gyyun/issues).
...
* When you're done, send a Pull Request to gyyun, please refer to the《[Submit Guide-Submit Pull Request Process](./submit-code.md)》
