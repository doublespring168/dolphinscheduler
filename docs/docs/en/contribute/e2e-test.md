...
```java
package com.gyyun.ds.e2e.pages;
...
For navigation bar options jumping, the goToNav method is provided in `com/gyyun/ds/e2e/pages/common/NavBarPage.java`. The currently supported pages are: ProjectPage, SecurityPage and ResourcePage.
...
https://github.com/apache/gyyun/tree/dev/gyyun-e2e/gyyun-e2e-case/src/test/java/com/gyyun/ds/e2e/cases
