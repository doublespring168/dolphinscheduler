...
package com.gyyun.ds.plugin.datasource.hive;

import static com.gyyun.ds.plugin.task.api.TaskConstants.HADOOP_SECURITY_AUTHENTICATION_STARTUP_STATE;
import static com.gyyun.ds.plugin.task.api.TaskConstants.JAVA_SECURITY_KRB5_CONF;
import static com.gyyun.ds.plugin.task.api.TaskConstants.JAVA_SECURITY_KRB5_CONF_PATH;

import com.gyyun.ds.common.utils.PropertyUtils;
import com.gyyun.ds.plugin.datasource.api.client.BasePooledDataSourceClient;
import com.gyyun.ds.plugin.datasource.hive.security.UserGroupInformationFactory;
