...
package org.apache.gyyun.plugin.datasource.ssh;
...
public class SSHDataSourceProcessorTest {
    ...
    private String connectJson =
            "{\"user\":\"lucky\",\"password\":\"123456\",\"host\":\"gyyun.com\",\"port\":22, \"privateKey\":\"ssh-rsa AAAAB\"}";
    ...
    void testCreateDatasourceParamDTO() {
        ...
        Assertions.assertEquals("gyyun.com", sshDataSourceParamDTO.getHost());
    ...
    void testCreateConnectionParams() {
        ...
        Assertions.assertEquals("gyyun.com", sshConnectionParam.getHost());
