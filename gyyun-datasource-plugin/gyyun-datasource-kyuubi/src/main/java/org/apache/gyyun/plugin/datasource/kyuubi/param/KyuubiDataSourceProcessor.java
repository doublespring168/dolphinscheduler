...
package org.apache.gyyun.plugin.datasource.kyuubi.param;
...
public class KyuubiDataSourceProcessor extends AbstractDataSourceProcessor {
    ...
    public Connection getConnection(ConnectionParam connectionParam) throws SQLException {
        ...
        return JdbcDriverConnectionProvider.builder()
                ...
                .jdbcUrl(getJdbcUrl(kyuubiConnectionParam))
                .username(kyuubiConnectionParam.getUser())
                .password(PasswordUtils.decodePassword(kyuubiConnectionParam.getPassword()))
                .build()
                .getConnection();
    }
