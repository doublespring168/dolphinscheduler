...
package org.apache.gyyun.plugin.datasource.zeppelin;

import org.apache.gyyun.plugin.datasource.zeppelin.param.ZeppelinConnectionParam;
import org.apache.gyyun.plugin.datasource.zeppelin.param.ZeppelinDataSourceParamDTO;
import org.apache.gyyun.plugin.datasource.zeppelin.param.ZeppelinDataSourceProcessor;
...
public class ZeppelinDataSourceProcessorTest {
    ...
    private String connectJson =
            "{\"username\":\"lucky\",\"password\":\"123456\",\"restEndpoint\":\"https://gyyun.com:8080\"}";
    ...
    void testCheckDatasourceParam() {
        ...
        zeppelinDataSourceParamDTO.setRestEndpoint("http://gyyun.com:8080");
        Assertions.assertThrows(IllegalArgumentException.class,
                () -> zeppelinDataSourceProcessor.checkDatasourceParam(zeppelinDataSourceParamDTO));
    ...
    void testGetDatasourceUniqueId() {
        ...
        zeppelinConnectionParam.setRestEndpoint("https://gyyun.com:8080");
        zeppelinConnectionParam.setUsername("root");
        zeppelinConnectionParam.setPassword("123456");
        Assertions.assertEquals("zeppelin@https://gyyun.com:8080@root@123456",
    ...
    void testCreateDatasourceParamDTO() {
        ...
        Assertions.assertEquals("https://gyyun.com:8080", zeppelinDataSourceParamDTO.getRestEndpoint());
    }
    ...
    void testCreateConnectionParams() {
        ...
        Assertions.assertEquals("https://gyyun.com:8080", zeppelinConnectionParam.getRestEndpoint());
    }
