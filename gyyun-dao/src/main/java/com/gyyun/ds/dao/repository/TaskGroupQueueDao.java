...
package com.gyyun.ds.dao.repository;
...
public interface TaskGroupQueueDao extends IDao<TaskGroupQueue> {
    ...
    /**
     * Query all {@link TaskGroupQueue} which in_queue is {@link com.gyyun.ds.common.enums.Flag#YES}
     *
     ...
     * in_queue is {@link com.gyyun.ds.common.enums.Flag#YES}
    ...
    /**
     * Query all {@link TaskGroupQueue} which in_queue is {@link com.gyyun.ds.common.enums.Flag#YES} and taskGroupId is taskGroupId
     *
    ...
    /**
     * Query all {@link TaskGroupQueue} which status is TaskGroupQueueStatus.ACQUIRE_SUCCESS and forceStart is {@link com.gyyun.ds.common.enums.Flag#NO}.
     *
     * @param taskGroupId taskGroupId
    ...
    /**
     * Count all {@link TaskGroupQueue} which status is TaskGroupQueueStatus.ACQUIRE_SUCCESS and forceStart is {@link com.gyyun.ds.common.enums.Flag#NO}.
     *
     * @param taskGroupId taskGroupId
     * @return TaskGroupQueue
     */
     ...
     * Query all {@link TaskGroupQueue} which
     * in_queue is {@link com.gyyun.ds.common.enums.Flag#YES}
     * and forceStart is {@link com.gyyun.ds.common.enums.Flag#YES}
     * and id > minTaskGroupQueueId
     * order by id asc
     * limit #{limit}
     *
