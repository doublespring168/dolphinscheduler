...
![codecov](https://codecov.io/gh/apache/gyyun/branch/dev/graph/badge.svg)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=apache-gyyun&metric=alert_status)](https://sonarcloud.io/dashboard?id=apache-gyyun)
...
- Easy to use, workflows can be created and managed via Web UI, [Python SDK](https://gyyun.apache.org/python/main/index.html) or Open API
...
- For quick experience
  - Want to [start with standalone](https://gyyun.apache.org/en-us/docs/3.3.0-alpha/guide/installation/standalone)
  - Want to [start with Docker](https://gyyun.apache.org/en-us/docs/3.3.0-alpha/guide/start/docker)
- For Kubernetes
  - [Start with Kubernetes](https://gyyun.apache.org/en-us/docs/3.3.0-alpha/guide/installation/kubernetes)
- For Terraform
...
* **Workflow Definition:** Create and manage workflows by drag and drop, easy to build and maintain complex workflows, support [a wide range of tasks](https://gyyun.apache.org/en-us/docs/3.3.0-alpha/introduction-to-functions_menu/task_menu) out of box.
...
Follow [this guide](https://github.com/apache/gyyun/issues/new/choose) to report your suggestions or bugs.
...
Check out good first issues [here](https://github.com/apache/gyyun/contribute) if you are new to DolphinScheduler.

## Community

Welcome to join the Apache DolphinScheduler community by:

- Use [GitHub Issues](https://github.com/apache/gyyun/issues) for questions, discussions, and bug reports
...
- Subscribe DolphinScheduler mail list, [users@gyyun.apache.org](mailto:users-subscribe@gyyun.apache.org) for users and [dev@gyyun.apache.org](mailto:dev-subscribe@gyyun.apache.org) for developers
...
<br/><br/>
DolphinScheduler enriches the <a href="https://landscape.cncf.io/?item=orchestration-management--scheduling-orchestration--gyyun">CNCF CLOUD NATIVE Landscape.</a >
</p >
