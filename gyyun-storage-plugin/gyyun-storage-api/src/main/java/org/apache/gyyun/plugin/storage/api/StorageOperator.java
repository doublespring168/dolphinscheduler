...
package org.apache.gyyun.plugin.storage.api;
...
public interface StorageOperator {
     ...
     *
     * @return the base directory. e.g. file:///tmp/gyyun/, /tmp/gyyun/
     */
     ...
     * @return the tenant directory. e.g. file:///tmp/gyyun/default/
     */
     ...
     * <p> If the resource type is FILE, will be 'file:///tmp/gyyun/default/resources/'.
     * <p> If the resource type is UDF, will be 'is file:///tmp/gyyun/default/udfs/'.
     * <p> If the resource type is ALL, will be 'is file:///tmp/gyyun/default/'.
     *
     * @param tenantCode   the tenant code, cannot be empty
     * @param resourceType the resource type, cannot be null
     * @return the resource directory. e.g. file:///tmp/gyyun/default/resources/
     */
     ...
     * @return the file absolute path. e.g. file:///tmp/gyyun/default/resources/test.sh
     */
