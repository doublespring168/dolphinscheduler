...
import static org.apache.gyyun.plugin.storage.api.constants.StorageConstants.FS_DEFAULT_FS;
import static org.apache.gyyun.plugin.storage.api.constants.StorageConstants.HDFS_ROOT_USER;

import org.apache.gyyun.common.utils.PropertyUtils;
import org.apache.gyyun.plugin.storage.api.StorageOperator;
import org.apache.gyyun.plugin.storage.api.StorageOperatorFactory;
import org.apache.gyyun.plugin.storage.api.StorageType;
import org.apache.gyyun.plugin.storage.api.constants.StorageConstants;
...
public class HdfsStorageOperatorFactory implements StorageOperatorFactory {
    ...
    private HdfsStorageProperties getHdfsStorageProperties() {
        ...
        return HdfsStorageProperties.builder()
                ...
                .resourceUploadPath(PropertyUtils.getString(StorageConstants.RESOURCE_UPLOAD_PATH, "/gyyun"))
                .build();
    }
