...
package com.gyyun.ds.api.audit.enums;

import static com.gyyun.ds.api.audit.constants.AuditLogConstants.ALIAS;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.CLUSTER_CODE;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.CODE;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.CODES;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.ENVIRONMENT_CODE;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.FILE_NAME;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.FULL_NAME;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.ID;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.NAME;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.PRIORITY;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.QUEUE_ID;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.TYPE;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.USER_ID;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.VERSION;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.WORKFLOW_DEFINITION_CODE;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.WORKFLOW_DEFINITION_CODES;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.WORKFLOW_INSTANCE_ID;
import static com.gyyun.ds.api.audit.constants.AuditLogConstants.WORKFLOW_INSTANCE_IDS;
import static com.gyyun.ds.common.enums.AuditModelType.ALARM_GROUP;
import static com.gyyun.ds.common.enums.AuditModelType.ALARM_INSTANCE;
import static com.gyyun.ds.common.enums.AuditModelType.CLUSTER;
import static com.gyyun.ds.common.enums.AuditModelType.DATASOURCE;
import static com.gyyun.ds.common.enums.AuditModelType.ENVIRONMENT;
import static com.gyyun.ds.common.enums.AuditModelType.FILE;
import static com.gyyun.ds.common.enums.AuditModelType.FOLDER;
import static com.gyyun.ds.common.enums.AuditModelType.K8S_NAMESPACE;
import static com.gyyun.ds.common.enums.AuditModelType.PROJECT;
import static com.gyyun.ds.common.enums.AuditModelType.SCHEDULE;
import static com.gyyun.ds.common.enums.AuditModelType.TASK;
import static com.gyyun.ds.common.enums.AuditModelType.TASK_GROUP;
import static com.gyyun.ds.common.enums.AuditModelType.TASK_INSTANCE;
import static com.gyyun.ds.common.enums.AuditModelType.TENANT;
import static com.gyyun.ds.common.enums.AuditModelType.TOKEN;
import static com.gyyun.ds.common.enums.AuditModelType.USER;
import static com.gyyun.ds.common.enums.AuditModelType.WORKER_GROUP;
import static com.gyyun.ds.common.enums.AuditModelType.WORKFLOW;
import static com.gyyun.ds.common.enums.AuditModelType.WORKFLOW_INSTANCE;
import static com.gyyun.ds.common.enums.AuditModelType.YARN_QUEUE;
import static com.gyyun.ds.common.enums.AuditOperationType.BATCH_DELETE;
import static com.gyyun.ds.common.enums.AuditOperationType.BATCH_RERUN;
import static com.gyyun.ds.common.enums.AuditOperationType.BATCH_START;
import static com.gyyun.ds.common.enums.AuditOperationType.CLOSE;
import static com.gyyun.ds.common.enums.AuditOperationType.COPY;
import static com.gyyun.ds.common.enums.AuditOperationType.CREATE;
import static com.gyyun.ds.common.enums.AuditOperationType.DELETE;
import static com.gyyun.ds.common.enums.AuditOperationType.DELETE_VERSION;
import static com.gyyun.ds.common.enums.AuditOperationType.EXECUTE;
import static com.gyyun.ds.common.enums.AuditOperationType.EXPORT;
import static com.gyyun.ds.common.enums.AuditOperationType.FORCE_SUCCESS;
import static com.gyyun.ds.common.enums.AuditOperationType.IMPORT;
import static com.gyyun.ds.common.enums.AuditOperationType.MODIFY;
import static com.gyyun.ds.common.enums.AuditOperationType.OFFLINE;
import static com.gyyun.ds.common.enums.AuditOperationType.ONLINE;
import static com.gyyun.ds.common.enums.AuditOperationType.RELEASE;
import static com.gyyun.ds.common.enums.AuditOperationType.START;
import static com.gyyun.ds.common.enums.AuditOperationType.SWITCH_VERSION;
import static com.gyyun.ds.common.enums.AuditOperationType.UPDATE;

import com.gyyun.ds.api.audit.constants.AuditLogConstants;
import com.gyyun.ds.api.audit.operator.AuditOperator;
import com.gyyun.ds.api.audit.operator.impl.AlertGroupAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.AlertInstanceAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.ClusterAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.DatasourceAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.EnvironmentAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.K8SNamespaceAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.ProjectAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.ResourceAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.ScheduleAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.TaskAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.TaskGroupAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.TaskInstancesAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.TenantAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.TokenAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.UserAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.WorkerGroupAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.WorkflowAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.WorkflowInstanceAuditOperatorImpl;
import com.gyyun.ds.api.audit.operator.impl.YarnQueueAuditOperatorImpl;
import com.gyyun.ds.common.enums.AuditModelType;
import com.gyyun.ds.common.enums.AuditOperationType;
