...
import static com.gyyun.ds.api.enums.Status.DOWNLOAD_TASK_INSTANCE_LOG_FILE_ERROR;
import static com.gyyun.ds.api.enums.Status.QUERY_TASK_INSTANCE_LOG_ERROR;

import com.gyyun.ds.api.exceptions.ApiException;
import com.gyyun.ds.api.service.LoggerService;
import com.gyyun.ds.api.utils.Result;
import com.gyyun.ds.common.constants.Constants;
import com.gyyun.ds.dao.entity.ResponseTaskLog;
