...
package org.apache.gyyun.api.audit.enums;

import static org.apache.gyyun.api.audit.constants.AuditLogConstants.ALIAS;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.CLUSTER_CODE;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.CODE;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.CODES;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.ENVIRONMENT_CODE;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.FILE_NAME;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.FULL_NAME;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.ID;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.NAME;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.PRIORITY;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.QUEUE_ID;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.TYPE;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.USER_ID;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.VERSION;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.WORKFLOW_DEFINITION_CODE;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.WORKFLOW_DEFINITION_CODES;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.WORKFLOW_INSTANCE_ID;
import static org.apache.gyyun.api.audit.constants.AuditLogConstants.WORKFLOW_INSTANCE_IDS;
import static org.apache.gyyun.common.enums.AuditModelType.ALARM_GROUP;
import static org.apache.gyyun.common.enums.AuditModelType.ALARM_INSTANCE;
import static org.apache.gyyun.common.enums.AuditModelType.CLUSTER;
import static org.apache.gyyun.common.enums.AuditModelType.DATASOURCE;
import static org.apache.gyyun.common.enums.AuditModelType.ENVIRONMENT;
import static org.apache.gyyun.common.enums.AuditModelType.FILE;
import static org.apache.gyyun.common.enums.AuditModelType.FOLDER;
import static org.apache.gyyun.common.enums.AuditModelType.K8S_NAMESPACE;
import static org.apache.gyyun.common.enums.AuditModelType.PROJECT;
import static org.apache.gyyun.common.enums.AuditModelType.SCHEDULE;
import static org.apache.gyyun.common.enums.AuditModelType.TASK;
import static org.apache.gyyun.common.enums.AuditModelType.TASK_GROUP;
import static org.apache.gyyun.common.enums.AuditModelType.TASK_INSTANCE;
import static org.apache.gyyun.common.enums.AuditModelType.TENANT;
import static org.apache.gyyun.common.enums.AuditModelType.TOKEN;
import static org.apache.gyyun.common.enums.AuditModelType.USER;
import static org.apache.gyyun.common.enums.AuditModelType.WORKER_GROUP;
import static org.apache.gyyun.common.enums.AuditModelType.WORKFLOW;
import static org.apache.gyyun.common.enums.AuditModelType.WORKFLOW_INSTANCE;
import static org.apache.gyyun.common.enums.AuditModelType.YARN_QUEUE;
import static org.apache.gyyun.common.enums.AuditOperationType.BATCH_DELETE;
import static org.apache.gyyun.common.enums.AuditOperationType.BATCH_RERUN;
import static org.apache.gyyun.common.enums.AuditOperationType.BATCH_START;
import static org.apache.gyyun.common.enums.AuditOperationType.CLOSE;
import static org.apache.gyyun.common.enums.AuditOperationType.COPY;
import static org.apache.gyyun.common.enums.AuditOperationType.CREATE;
import static org.apache.gyyun.common.enums.AuditOperationType.DELETE;
import static org.apache.gyyun.common.enums.AuditOperationType.DELETE_VERSION;
import static org.apache.gyyun.common.enums.AuditOperationType.EXECUTE;
import static org.apache.gyyun.common.enums.AuditOperationType.EXPORT;
import static org.apache.gyyun.common.enums.AuditOperationType.FORCE_SUCCESS;
import static org.apache.gyyun.common.enums.AuditOperationType.IMPORT;
import static org.apache.gyyun.common.enums.AuditOperationType.MODIFY;
import static org.apache.gyyun.common.enums.AuditOperationType.OFFLINE;
import static org.apache.gyyun.common.enums.AuditOperationType.ONLINE;
import static org.apache.gyyun.common.enums.AuditOperationType.RELEASE;
import static org.apache.gyyun.common.enums.AuditOperationType.START;
import static org.apache.gyyun.common.enums.AuditOperationType.SWITCH_VERSION;
import static org.apache.gyyun.common.enums.AuditOperationType.UPDATE;

import org.apache.gyyun.api.audit.constants.AuditLogConstants;
import org.apache.gyyun.api.audit.operator.AuditOperator;
import org.apache.gyyun.api.audit.operator.impl.AlertGroupAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.AlertInstanceAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.ClusterAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.DatasourceAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.EnvironmentAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.K8SNamespaceAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.ProjectAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.ResourceAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.ScheduleAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.TaskAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.TaskGroupAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.TaskInstancesAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.TenantAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.TokenAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.UserAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.WorkerGroupAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.WorkflowAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.WorkflowInstanceAuditOperatorImpl;
import org.apache.gyyun.api.audit.operator.impl.YarnQueueAuditOperatorImpl;
import org.apache.gyyun.common.enums.AuditModelType;
import org.apache.gyyun.common.enums.AuditOperationType;
