...
import static org.apache.gyyun.api.enums.Status.IP_IS_EMPTY;
import static org.apache.gyyun.api.enums.Status.NOT_SUPPORT_SSO;
import static org.apache.gyyun.api.enums.Status.SIGN_OUT_ERROR;
import static org.apache.gyyun.api.enums.Status.USER_LOGIN_FAILURE;

import org.apache.gyyun.api.configuration.ApiConfig;
import org.apache.gyyun.api.configuration.OAuth2Configuration;
import org.apache.gyyun.api.enums.Status;
import org.apache.gyyun.api.exceptions.ApiException;
import org.apache.gyyun.api.security.Authenticator;
import org.apache.gyyun.api.security.impl.AbstractSsoAuthenticator;
import org.apache.gyyun.api.security.impl.oidc.OidcAuthenticator;
import org.apache.gyyun.api.security.impl.oidc.OidcConfigProperties;
import org.apache.gyyun.api.service.SessionService;
...
import org.apache.gyyun.common.model.OkHttpRequestHeaderContentType;
import org.apache.gyyun.common.model.OkHttpRequestHeaders;
import org.apache.gyyun.common.utils.JSONUtils;
import org.apache.gyyun.common.utils.OkHttpUtils;
import org.apache.gyyun.dao.entity.Session;
...
public class LoginController extends BaseController {
    ...
    public void handleOidcCallback(@PathVariable String providerId,
        ...
        if (!state.startsWith(providerId + ":")) {
            ...
            response.sendRedirect("/gyyun/ui/#/login?error=oidc_invalid_state");
            return;
        }
        ...
        if (error != null) {
            ...
            response.sendRedirect("/gyyun/ui/#/login?error=oidc_login_failed");
            return;
        }
        ...
        if (code == null) {
            ...
            response.sendRedirect("/gyyun/ui/#/login?error=oidc_missing_code");
            return;
        }
        ...
        try {
            if (!(authenticator instanceof OidcAuthenticator)) {
                ...
                response.sendRedirect("/gyyun/ui/#/login?error=oidc_not_enabled");
                return;
            }
            ...
            if (user == null) {
                ...
                response.sendRedirect("/gyyun/ui/#/login?error=oidc_authentication_failed");
                return;
            }
            ...
            try {
                response.sendRedirect("/gyyun/ui/#/login?error=oidc_critical_error");
            } catch (IOException e) {
    ...
    public void redirectToOidc(@PathVariable String providerId, HttpServletRequest request,
        ...
        if (oidcConfigProperties == null || oidcConfigProperties.getProviders() == null
            ...
            response.sendRedirect("/gyyun/ui/#/login?error=invalid_provider");
            return;
        }
        ...
        if (authorizationUrl == null) {
            ...
            response.sendRedirect("/gyyun/ui/#/login?error=oidc_authorization_url_null");
            return;
        }
