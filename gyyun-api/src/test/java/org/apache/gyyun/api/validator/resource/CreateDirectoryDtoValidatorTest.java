...
import static org.apache.gyyun.api.AssertionsHelper.assertThrowServiceException;
...
class CreateDirectoryDtoValidatorTest {
    ...
    public void testValidate_directoryPathContainsIllegalSymbolic() {
        CreateDirectoryDto createDirectoryDto = CreateDirectoryDto.builder()
                .loginUser(loginUser)
                .directoryAbsolutePath("/tmp/gyyun/default/resources/..")
                .build();
        assertThrowServiceException(
    ...
    public void testValidate_directoryExist() {
        CreateDirectoryDto createDirectoryDto = CreateDirectoryDto.builder()
                .loginUser(loginUser)
                .directoryAbsolutePath("/tmp/gyyun/default/resources/demo")
                .build();
        when(storageOperator.exists(createDirectoryDto.getDirectoryAbsolutePath())).thenReturn(true);
        assertThrowServiceException(
                "Internal Server Error: The resource is already exist: /tmp/gyyun/default/resources/demo",
                () -> createDirectoryDtoValidator.validate(createDirectoryDto));
    }
    ...
    public void testValidate_NoPermission() {
        ...
        assertThrowServiceException(
                "Internal Server Error: The user's tenant is test have no permission to access the resource: /tmp/gyyun/default/resources/demo",
                () -> createDirectoryDtoValidator.validate(createDirectoryDto));
    }
    ...
    public void testValidate_pathNotDirectory() {
        CreateDirectoryDto createDirectoryDto = CreateDirectoryDto.builder()
                .loginUser(loginUser)
                .directoryAbsolutePath("/tmp/gyyun/default/resources/demo.sql")
                .build();
        loginUser.setUserType(UserType.ADMIN_USER);
        assertThrowServiceException(
                "Internal Server Error: The path is not a directory: /tmp/gyyun/default/resources/demo.sql",
                () -> createDirectoryDtoValidator.validate(createDirectoryDto));
    }
