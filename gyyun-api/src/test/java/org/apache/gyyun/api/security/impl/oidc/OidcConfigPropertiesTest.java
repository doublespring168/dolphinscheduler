...
package org.apache.gyyun.api.security.impl.oidc;

import org.apache.gyyun.api.controller.AbstractControllerTest;
...
@TestPropertySource(properties = {
        ...
        "security.authentication.oidc.providers.keycloak.issuer-uri=http://keycloak:8080/realms/gyyun",
        "security.authentication.oidc.providers.keycloak.client-id=gyyun-client",
        ...
        "security.authentication.oidc.user.admin-group-mapping[0]=gyyun-admins"
})
public class OidcConfigPropertiesTest extends AbstractControllerTest {
    ...
    public void testOidcConfigPropertiesLoading() {
        ...
        Assertions.assertEquals("http://keycloak:8080/realms/gyyun", keycloakConfig.getIssuerUri());
        Assertions.assertEquals("gyyun-client", keycloakConfig.getClientId());
        ...
        Assertions.assertEquals(Collections.singletonList("gyyun-admins"),
