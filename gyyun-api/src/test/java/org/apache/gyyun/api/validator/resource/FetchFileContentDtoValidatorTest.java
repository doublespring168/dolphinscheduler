...
class FetchFileContentDtoValidatorTest {
    ...
    public void testValidate_filePathContainsIllegalSymbolic() {
        FetchFileContentDto fetchFileContentDto = FetchFileContentDto.builder()
                .loginUser(loginUser)
                .resourceFileAbsolutePath("/tmp/gyyun/default/resources/..")
                .skipLineNum(0)
                .limit(-1)
                .build();
        assertThrowServiceException(
    ...
    public void testValidate_IsNotFile() {
        FetchFileContentDto fetchFileContentDto = FetchFileContentDto.builder()
                .loginUser(loginUser)
                .resourceFileAbsolutePath("/tmp/gyyun/default/resources/a")
                .skipLineNum(0)
                .limit(-1)
                .build();
        assertThrowServiceException(
    ...
    public void testValidate_fileNoPermission() {
        ...
        FetchFileContentDto fetchFileContentDto = FetchFileContentDto.builder()
                .loginUser(loginUser)
                .resourceFileAbsolutePath("/tmp/gyyun/default/resources/a.sql")
                .skipLineNum(0)
                .limit(-1)
                .build();
    ...
    void validate_fileExtensionInvalid() {
        ...
        FetchFileContentDto fetchFileContentDto = FetchFileContentDto.builder()
                .loginUser(loginUser)
                .resourceFileAbsolutePath("/tmp/gyyun/default/resources/a.jar")
                .skipLineNum(0)
                .limit(-1)
                .build();
        when(storageOperator.exists(fetchFileContentDto.getResourceFileAbsolutePath())).thenReturn(false);
