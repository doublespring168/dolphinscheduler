  ...
  render() {
    return (
      <NLayout style='height: 100%'>
        <NLayoutHeader style='height: var(--ala-header-height)'>
          <NavBar
        ...
        <NLayout has-sider position='absolute' style='top: var(--ala-header-height)'>
          {this.isShowSide && (
            <SideBar
          ...
          <NLayoutContent
            ...
            style='padding: var(--ala-content-padding)'
